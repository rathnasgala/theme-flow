...
Flow is an official Gala appearance theme with calm teal and sage, organic surfaces, generous
reading rhythm, and soft asymmetric cards. It changes presentation only: Gala's managed templates,
authentication, analytics, accessibility behavior, security policy, and publishing workflow remain
authoritative.
...
1. Publish this repository as `rathnasgala/theme-flow`.
...
4. Enter repository `theme-flow`, enter the exact SHA, and select **Verify release**.
5. Authors can then select **Flow** in their publication's Appearance settings when its framework
